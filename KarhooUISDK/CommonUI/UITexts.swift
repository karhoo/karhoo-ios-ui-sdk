...
public enum UITexts {
    ...
    public enum Booking {
        ...
        public static let noAvailabilityForPrebookRideTitle = "kh_uisdk_quotes_error_no_availability_title".localized
        public static let noAvailabilityForPrebookRideSubtitle = "kh_uisdk_quotes_error_no_availability_subtitle".localized
