...
/*
 ...
 //    var actions: AddPassengerDetailsViewDelegate? // could be removed
 ...
 passengerDetailsIcon.image = UIImage.uisdkImage("kh_uisdk_user_icon")
 ...
 passengerDetailsTitle.text = UITexts.PassengerDetails.title
 passengerDetailsSubtitle.text = UITexts.PassengerDetails.add
 passengerDetailsImage.image = UIImage.uisdkImage("kh_uisdk_user_icon")
