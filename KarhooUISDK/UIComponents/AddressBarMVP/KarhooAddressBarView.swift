...
public class KarhooAddressBarView: UIView, AddressBarView {
    ...
    private func setUpView() {
        ...
        destinationIcon.image = UIImage.uisdkImage("kh_add_destination")
        ...
        swapButton.setImage(UIImage.uisdkImage("kh_address_swap").withRenderingMode(.alwaysTemplate), for: .normal)
    ...
    public func destinationNotSetState() {
        ...
        destinationIcon.image = UIImage.uisdkImage("kh_add_destination").withRenderingMode(.alwaysTemplate)
