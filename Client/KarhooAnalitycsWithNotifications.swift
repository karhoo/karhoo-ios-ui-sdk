//
//  KarhooAnalitycsWithNotifications.swift
//  Client
//
...
class KarhooAnalitycsWithNotifications: Analytics {
    
    private let base: AnalyticsService = KarhooAnalitycsServiceWithNotifications()
