...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "KarhooSDK", url: "https://github.com/karhoo/karhoo-ios-sdk", .exact(Version(1, 5, 4))),
        .package(name: "Adyen", url: "https://github.com/Adyen/adyen-ios", .exact(Version(3, 9, 0))),
